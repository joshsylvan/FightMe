...
//	AnimationClip clip;
	void Start () {
		...
		for (int i = 0; i < gestures [0].GetPoints ().Length; i++) {
			keysX [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetPoints ()[i].getX());
		}
		...
		for (int i = 0; i < gestures [0].GetPoints ().Length; i++) {
			keysY [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetPoints ()[i].getY());
		}
		...
		for (int i = 0; i < gestures [0].GetPoints ().Length; i++) {
			keysZ [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetPoints ()[i].getZ());
		}
		...
		for (int i = 0; i < gestures [0].GetRotations ().Length; i++) {
			rKeyX [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetRotations ()[i].x);
		}
		...
		for (int i = 0; i < gestures [0].GetRotations ().Length; i++) {
			rKeyY [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetRotations ()[i].y);
		}
		...
		for (int i = 0; i < gestures [0].GetRotations ().Length; i++) {
			rKeyZ [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetRotations ()[i].z);
		}
		...
		for (int i = 0; i < gestures [0].GetRotations ().Length; i++) {
			rKeyW [i] = new Keyframe (gestures [0].GetPoints ()[i].GetDeltaTime(), gestures [0].GetRotations ()[i].w);
		}
